...
<head>
	...
	<meta name="robots" content="noindex" />
        ...
        <link href="<?php echo base_url( 'themes/admin/assets/jquery-ui/jquery-ui.min.css' ); ?>" rel="stylesheet" type="text/css"/>
        <script src="<?php echo base_url( 'themes/admin/assets/jquery-ui/jquery-ui.js' ); ?>" type="text/javascript"></script>

        
        <link href="<?php echo base_url( 'themes/admin/assets/datatables/css/jquery.dataTables.min.css' ); ?>" rel="stylesheet" type="text/css"/>
        <script src="<?php echo base_url( 'themes/admin/assets/datatables/js/jquery.dataTables.min.js' ); ?>" type="text/javascript"></script>

        <link href="<?php echo base_url( 'themes/admin/assets/colorbox/colorbox.css' ); ?>" rel="stylesheet" type="text/css"/>
        <script src="<?php echo base_url( 'themes/admin/assets/colorbox/jquery.colorbox.min.js' ); ?>" type="text/javascript"></script>
    <?php
    ...
    <div class="navbar navbar-static-top navbar-inverse" id="topbar" >
        <div class="navbar-inner">
            <div class="container-fluid">
                ...
                <?php
                    echo    anchor( '/', '<img src="' . base_url( 'themes/admin/images/logo.png' ) . '" title="' . html_escape( $this->settings_lib->item( 'site.title' ) ) . '" class="img-responsive img-thumbnail img-fluid" style="height: 20px; width: 51px; margin: 0; padding: 0;" />', 'class="brand"' );
                    if ( 
