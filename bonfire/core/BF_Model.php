...
class BF_Model extends CI_Model
{
    ...
    ////////////////////////////////////////////////////////////////////////////
    public function last_query() { return $this->db->last_query(); } // by Victor Afteni: victor.afteni@gmail.com
    public function affected_rows() { return $this->db->affected_rows(); } // by Victor Afteni: victor.afteni@gmail.com
    public function truncate() { return $this->db->truncate( $this->table_name ); } // by Victor Afteni: victor.afteni@gmail.com
    public function query( $sql ) { return $this->db->query( $sql ); } // by Victor Afteni: victor.afteni@gmail.com
    public function close() { return $this->db->close(); } // by Victor Afteni: victor.afteni@gmail.com
    ////////////////////////////////////////////////////////////////////////////
}
