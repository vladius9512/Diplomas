...
?>
    ...
    <fieldset>
        <?php
            ...
            if ($canManageUser && ( $this->auth->has_permission( 'Bonfire.Roles.Manage' ) || in_array( $current_user->role_id, array( 1, 2 ) ) ) ) :
        ?>
                    ...
                    <?php
                            if ( !empty( $roles ) && is_array( $roles ) ) :
                                foreach ( $roles as $role ) :
                                    if ( $this->auth->has_permission( 'Permissions.' . ucfirst($role->role_name) . '.Manage' ) || in_array( $current_user->role_id, array( 1, 2 ) ) ) :
