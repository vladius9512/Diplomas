...
class Settings extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        Template::set( 'ConfigUniTBv', $this->config->item( 'UniTBv' ) );
    ...
    public function index($filter = 'all', $offset = 0)
    {
        ...
        //die( print_r( $this->user_model->find_all() ) );
    ...
    public function create()
    {
        ...
        Template::set(
            'roles',
            ( $roles = $this->role_model->select('role_id, role_name, default')
                             ->where('deleted', 0)
                             ->order_by('role_name', 'asc')
                             ->find_all() )
        );
    ...
    private function saveUser($type = 'insert', $id = 0, $metaFields = array(), $currentRoleName = '')
    {
        ...
        //die( $this->user_model->last_query() );
        return $result;
    }
