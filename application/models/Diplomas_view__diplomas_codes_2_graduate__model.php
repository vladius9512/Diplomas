...
class diplomas_view__diplomas_codes_2_graduate__model extends MY_Model
{
    public $table_name          = 'diplomas_codes_2_graduate';
...
//SELECT 
//    dbo.diplomas_codes.Diploma_Code_Value, 
//    dbo.diplomas_codes.Diploma_Code_Status, 
//    dbo.diplomas_graduates.Gratuate_ID,
//    dbo.diplomas_graduates.Diploma_Config_Id, 
//    (   SELECT  dbo.diplomas_config.Diploma_Config_Title 
//        FROM    dbo.diplomas_config 
//        WHERE   dbo.diplomas_config.Diploma_Config_Id = dbo.diplomas_graduates.Diploma_Config_Id 
//    )   AS      Diploma_Config_Title,
...
//FROM dbo.diplomas_codes 
//LEFT JOIN dbo.diplomas_graduates ON dbo.diplomas_graduates.Diploma_Code_Value = dbo.diplomas_codes.Diploma_Code_Value