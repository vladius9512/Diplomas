...
class address_helper_test extends CI_UnitTestCase {
    ...
    {
        $select = state_select('', 'MO', 'RO', 'valid_states');
    ...
    {
        $select = state_select('', 'MO', 'RO', 'valid_states', 'myClass');
    ...
    public function test_country_select_creates_select()
    {
        ...
        $select = country_select('', 'RO', 'myName');
        $this->assertTrue(strpos($select, '<select') === 0);
    }
    ...
    {
        $select = country_select('', 'RO', 'myName');
        $this->assertTrue(strpos($select, "value='RO' selected") !== false);
    }
    ...
    {
        $select = country_select('AF', 'RO', 'myName');
    ...
    {
        $select = country_select('', 'RO', 'myName', 'myClass');
        $this->assertTrue(strpos($select, 'class="myClass"') !== false);
    }
